 ...
 */
void Append_To_List( List *list, dataptr data );
 ...
 *
 * @return a pointer to the List segment
 */
 ...
 *
 * @return a pointer to the new DList
 */
DList* New_DList();
 ...
 * @param data the data to append
 */
void Append_To_DList( DList *list );
 ...
 * @param data the data to prepend
 *
 * @return a pointer to the new DList head
 */
